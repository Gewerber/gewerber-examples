# TODO — gewerber-examples

Аудит 2026-08: README обещает «Docker Compose setups (Serverpod + PostgreSQL)»,
репозиторий фактически пуст — обещание не выполнено.
...
- [x] Пример локальной dev-среды: postgres_test docker compose + прогон тестов бэкенда
      → `dev-environment/`
- [x] README: честно сослаться на deploy/ основного репо и перечислить существующие примеры
